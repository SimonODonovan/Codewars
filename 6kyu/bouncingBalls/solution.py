...
# height integer, bounce float, window float
# return positive integer on valid params otherwise -1
# ex. - h = 3, bounce = 0.66, window = 1.5, result is 3
# ex. - h = 3, bounce = 1, window = 1.5, result is -1
# Float parameter "h" in meters must be greater than 0
# Float parameter "bounce" must be greater than 0 and less than 1
# Float parameter "window" must be less than h.
