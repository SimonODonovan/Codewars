/*
    ...
    character appears more than once in the original 
    string. Ignore capitalization when determining if 
...
function duplicateEncode(word) {
    return word
        .toLowerCase()
        .split("")
        .map((value, index, arr) => (arr.indexOf(value) == arr.lastIndexOf(value)) ? "(" : ")")
        .join("");
}
