...
const validParentheses = require("../../../5kyu/validParentheses/solution")

describe('validParentheses Solution test', () => {
    ...
    describe('validParentheses Fixed tests', () => {
        act("()()((()", false);
        act("()", true);
        act("()()", true);
        act("(())", true);
    ...
    describe('validParentheses Random tests', () => {
