/*
    ...
    You were camping with your friends far away from home, but 
    when it's time to go back, you realize that your fuel 
...
const zeroFuelAlt = (distanceToPump, mpg, fuelLeft) => {
